...
class GuiStyle { 
  ...
  Rosepine() {
    ...
    this.textSize         = 20;
    this.accent           = color('#c4a7e7');
    this.lable            = color('#232136');
    this.blend            = function(c, a) {
      // blend base with alpha
      let base = color('#232136');
      return color(
        red(base) * (1 - a) + red(c) * a,
        green(base) * (1 - a) + green(c) * a,
        blue(base) * (1 - a) + blue(c) * a
      );
    }
    ...
    this.button = {
      ...
      font:               'JetBrains Mono',
      textSize:           20, 
      fillBg:             this.blend(this.accent, 0.9),
      fillBgHover:        this.accent,
      fillBgActive:       this.accent,
      fillLabel:          this.lable,
      fillLabelHover:     this.lable,
      fillLabelActive:    this.lable,
      strokeBg:           this.blend(this.accent, 0.9), 
      strokeBgHover:      this.accent, 
      strokeBgActive:     this.accent
    };
    
    this.toggle = {
      strokeWeight:       2, 
      rounding:           2,
      font:               'JetBrains Monoe',
      textSize:           20, 
    ...
    this.checkbox = {
      ...
      fillCheck:          this.blend(color('#817c9c'), 0.9), 
      fillCheckHover:     color('#817c9c'), 
      fillCheckActive:    color('#817c9c'), 
    ...
    this.slider = {
      ...
      fillTrack:          this.blend(color('#817c9c'), 0.9), 
      fillTrackHover:     color('#817c9c'), 
      fillTrackActive:    color('#817c9c'), 

      fillHandle:          this.blend(color('#59546d'), 0.9), 
      fillHandleHover:     color('#59546d'), 
      fillHandleActive:    color('#59546d'), 

      strokeBg:           this.blend(this.accent, 0.9), 
      strokeBgHover:      this.accent, 
      strokeBgActive:     this.accent, 

      strokeTrack:       this.blend(color('#817c9c'), 0.9), 
      strokeTrackHover:  color('#817c9c'), 
      strokeTrackActive: color('#817c9c'), 

      strokeHandle:        this.blend(color('#59546d'), 0.9), 
      strokeHandleHover:   color('#59546d'), 
      strokeHandleActive:  color('#59546d'), 
    }
